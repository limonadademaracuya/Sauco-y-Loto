...
INSERT INTO clientes (nombre, domicilio, dni, telefono, email, clave) VALUES
    ...
    ('Martín Díaz', 'Santa Fe 1890', '98765432', '321789456', null,'martin2024'),
    ...
    ('Valeria García', 'Juan B. Justo 4321', '12345678', '123789456', null,'valen1010'),
    ...
    ('Diego Britos', 'Honduras 1765', '78904561', '234567890', null,'britoslol'),
    ...
    ('Romina Smith', 'Gurruchaga 1765', '34561230', '567890123', null,'amolosperros'),
...
INSERT INTO facturas (letra, nro_pedido, fecha, monto, id_cliente, id_administrador, id_producto, forma_de_pago) VALUES
    ('A', 1, '2023-01-01', 150.00, 1, 1, 1, 'efectivo'),
    ('B', 2, CURDATE(), 200.00, 2, 2, 2, 'tarjeta'),
    ('C', 3, '2023-02-03', 100.00, 3, 3, 3, 'efectivo'),
    ('A', 4, '2023-06-04', 120.00, 4, 4, 4, 'efectivo'),
    ('B', 5, CURDATE(), 180.00, 5, 5, 5, 'tarjeta'),
    ('C', 6, '2023-11-06', 90.00, 6, 6, 6, 'efectivo'),
    ('A', 7, '2023-01-01', 200.00, 7, 7, 7, 'tarjeta'),
    ('B', 8, '2023-09-10', 150.00, 8, 8, 8, 'efectivo'),
    ('B', 9, '2023-08-09', 120.00, 9, 9, 9, 'tarjeta'),
    ('C', 10, '2023-03-25', 160.00, 10, 10, 10, 'efectivo'),
    ('C', 11, '2023-07-30', 190.00, 11, 11, 11, 'tarjeta'),
    ('A', 12, '2023-04-02', 110.00, 12, 12, 12, 'tarjeta'),
    ('C', 13, '2023-01-13', 130.00, 13, 13, 13, 'efectivo'),
    ('A', 14, '2023-12-14', 160.00, 14, 14, 14, 'tarjeta'),
    ('B', 15, '2023-12-14', 190.00, 15, 15, 15, 'efectivo');
