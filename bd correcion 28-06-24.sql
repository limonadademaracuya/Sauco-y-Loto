...
INSERT INTO facturas (letra, nro_pedido, fecha, id_cliente, id_administrador, forma_de_pago) VALUES
    ('A', 1, '2023-01-01', 1, 1, 'efectivo'),
    ('B', 2, CURDATE(), 2, 2, 'tarjeta'),
    ('C', 3, '2023-02-03', 3, 3, 'efectivo'),
    ('A', 4, '2023-06-04', 4, 4, 'efectivo'),
    ('B', 5, CURDATE(), 5, 5, 'tarjeta'),
    ('C', 6, '2023-11-06', 6, 6, 'efectivo'),
    ('A', 7, '2023-01-01', 7, 7, 'tarjeta'),
    ('B', 8, '2023-09-10', 8, 8, 'efectivo'),
    ('B', 9, '2023-08-09', 9, 9, 'tarjeta'),
    ('C', 10, '2023-03-25', 10, 10, 'efectivo'),
    ('C', 11, '2023-07-30', 11, 11, 'tarjeta'),
    ('A', 12, '2023-04-02', 12, 12, 'tarjeta'),
    ('C', 13, '2023-01-13', 13, 13, 'efectivo'),
    ('A', 14, '2023-12-14', 14, 14, 'tarjeta'),
    ('B', 15, '2023-12-14', 15, 15, 'efectivo');
