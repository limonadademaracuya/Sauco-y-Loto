...
INSERT INTO articulos (codigo, id_proveedor, articulo, tipo, precio, stock_actual, stock_minimo, stock_maximo) VALUES
...
INSERT INTO facturas (nro_pedido, fecha, monto, id_cliente, forma_de_pago) VALUES
    ('1', '2023-01-01', 150.00, '1', 'efectivo'),
    ('2', curdate(), 200.00, '2', 'tarjeta'),
    ('3', '2023-02-03', 100.00, '3', 'efectivo'),
    ('4', '2023-06-04', 120.00, '4', 'efectivo'),
    ('5', curdate(), 180.00, '5', 'tarjeta'),
    ('6', '2023-11-06', 90.00, '6', 'efectivo'),
    ('7', '2023-01-01', 200.00, '7', 'tarjeta'),
    ('8', '2023-09-10', 150.00, '8', 'efectivo'),
    ('9', '2023-08-09', 120.00, '9', 'tarjeta'),
    ('10', '2023-03-25', 160.00, '10', 'efectivo'),
    ('11', '2023-07-30', 190.00, '11', 'tarjeta'),
    ('12', '2023-04-02', 110.00, '12', 'tarjeta'),
    ('13', '2023-01-13', 130.00, '13', 'efectivo'),
	('14', '2023-12-14', 160.00, '14', 'tarjeta'),
    ('15', '2023-12-14', 190.00, '15', 'efectivo'),
    ('16', '2023-12-15', 130.00, '16', 'efectivo');
